...
namespace ecpru\tests;

use ecpru\PaymentPage;
use ecpru\SignatureHandler;
use ecpru\Payment;
...
class PaymentPageTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetUrl()
    {
        ...
        self::assertEquals(
            'https://paymentpage.ecpru.com/payment?project_id=100&interface_type=%7B%22id%22%3A23%7D'
